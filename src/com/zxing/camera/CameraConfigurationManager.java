...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		screenResolution = new Point(displayMetrics.widthPixels,
...
//		List<Size> mSupportedPreviewSizes = CameraManager.getCamera()
//				.getParameters().getSupportedPreviewSizes();
//		CaptureActivity.cameraSize = CaptureActivity.getOptimalPreviewSize(
//				mSupportedPreviewSizes, CaptureActivity.mywidth,
//				CaptureActivity.myheight);
//		cameraResolution=new Point(CaptureActivity.cameraSize.width,
//				 CaptureActivity.cameraSize.height);
//		 parameters.setPreviewSize(CaptureActivity.cameraSize.width,
//		 CaptureActivity.cameraSize.height);
		setFlash(parameters);
		setZoom(parameters);

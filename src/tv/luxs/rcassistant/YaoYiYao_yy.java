...
public class YaoYiYao_yy extends Activity {
...
//	private AnimationSet mAnimationSet = new AnimationSet(true);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_yaoyiyao_);
		initView();
		initSenor();
	}
	...
	private void initSenor() {
		...
		shakeListener = new ShakeListener(YaoYiYao_yy.this);
...
//	};
	...
	private OnClickListener bingClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			startActivity(new Intent(YaoYiYao_yy.this, Yao2yao.class));
		}
	};
